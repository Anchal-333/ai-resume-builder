  ...
  return (
    <div>
      ...
      >
        <section className="z-50">
          <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
            ...
            <div className="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
              <a
                href="/dashboard"
                className="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg bg-primary hover:bg-primary focus:ring-4 focus:ring-primary-300"
              >
                Get Started
                <svg
        ...
        <section className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12" style={{ backgroundColor: 'rgba(255, 255, 255, 0.8)' }}>
          ...
          <div className="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
            ...
            >
              ...
              <p className="mt-1 text-sm text-gray-600">
                Easily write prompt in your form using AI in just one click
              </p>
            </a>
